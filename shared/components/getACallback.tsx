...
export const GetACallback = () => {
  return (
    <div className="flex flex-col items-center justify-center gap-6 py-8 max-w-8xl">
      ...
      >
        <div className="flex flex-col items-center justify-center gap-6 max-w-8xl px-2 lg:flex-row lg:flex-wrap">
          <input
            name="date"
            type="date"
            ...
            className="border h-[3rem] border-gray-300 rounded-md px-4 py-2 w-full lg:w-[200px] focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
          />
          ...
          <input
            ...
            className="border h-[3rem] border-gray-300 rounded-md px-4 py-2 w-full lg:w-[300px] focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
          ...
          <button
            ...
            className="cursor-pointer bg-primary h-[3rem] px-10 text-white font-bold py-2 rounded w-full lg:w-auto hover:bg-primary-dark transition-colors duration-300"
          >
            Request A Call
          </button>
        </div>
